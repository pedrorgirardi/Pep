...
def analyze_classpath(window):
    ...
    if classpath := project_classpath(window):
        ...
        analysis_config = "{:output {:analysis {:var-usages false :var-definitions {:shallow true} :arglists true :keywords false :java-class-definitions false} :format :json :canonical-paths true}}"
